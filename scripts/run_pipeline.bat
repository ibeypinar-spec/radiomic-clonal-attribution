...
echo === FAZ 1: DICOM-NIfTI [%DATASET%] ===
python C:\RadyomikAtribuisyon\scripts\01_dicom_to_nifti.py --dataset %DATASET% >> C:\RadyomikAtribuisyon\results\pipeline_%DATASET%.log 2>&1
